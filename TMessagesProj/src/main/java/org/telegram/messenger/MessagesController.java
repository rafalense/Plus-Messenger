...
public class MessagesController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void addUsersToChannelNinja(int chat_id, ArrayList<TLRPC.InputUser> users, final BaseFragment fragment) {
                ...
                if (error != null) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.e(">>>>> 1101", error.code + " - error.text " + error.text);
                            Log.e(">>>>> 1101", error.code + " - error.text " + error.text);
                            Log.e(">>>>> 1101", error.code + " - error.text " + error.text);
                            Log.e(">>>>> 1101", error.code + " - error.text " + error.text);
                            Log.e(">>>>> 1101", error.code + " - error.text " + error.text);
    ...
    public void addUserToChatNinja(final int chat_id, final TLRPC.User user, final TLRPC.ChatFull info, int count_fwd, String botHash, final BaseFragment fragment) {
        Log.e(">>>> 1", ">>>> 1");
        Log.e(">>>> 1", ">>>> 1");
        Log.e(">>>> 1", ">>>> 1");
        Log.e(">>>> 1", ">>>> 1");
        ...
        ConnectionsManager.getInstance().sendRequest(request, new RequestDelegate() {
            ...
            public void run(TLObject response, TLRPC.TL_error error) {
                ...
                if(error!=null){
                    Log.e(">>>> 2-2", ">>>> ERROR"+ error.text + "CHANNEL ID: "+ chat_id);
                    Log.e(">>>> 2-2", ">>>> ERROR"+ error.text + "CHANNEL ID: "+ chat_id);
                    Log.e(">>>> 2-2", ">>>> ERROR"+ error.text + "CHANNEL ID: "+ chat_id);
                    Log.e(">>>> 2-2", ">>>> ERROR"+ error.text + "CHANNEL ID: "+ chat_id);
                    Log.e(">>>> 2-2", ">>>> ERROR"+ error.text + "CHANNEL ID: "+ chat_id);
                ...
                Log.e(">>>>> 33333-1"," response" + response.toString());
                Log.e(">>>>> 33333-1"," response" + response.toString());
                Log.e(">>>>> 33333-1"," response" + response.toString());
                Log.e(">>>>> 33333-1"," response" + response.toString());
                Log.e(">>>>> 33333-1"," response" + response.toString());
    ...
    public void addUserToChat(final int chat_id, final TLRPC.User user, final TLRPC.ChatFull info, int count_fwd, String botHash, final BaseFragment fragment) {
        ...
        Log.e(">>>>> 145", "addUserToChat("+chat_id+", " + user +", "+info +", " +count_fwd + ", "+botHash+", "+fragment+")");
        Log.e(">>>>> 145", "addUserToChat("+chat_id+", " + user +", "+info +", " +count_fwd + ", "+botHash+", "+fragment+")");
        Log.e(">>>>> 145", "addUserToChat("+chat_id+", " + user +", "+info +", " +count_fwd + ", "+botHash+", "+fragment+")");
        Log.e(">>>>> 145", "addUserToChat("+chat_id+", " + user +", "+info +", " +count_fwd + ", "+botHash+", "+fragment+")");
        Log.e(">>>>> 145", "addUserToChat("+chat_id+", " + user +", "+info +", " +count_fwd + ", "+botHash+", "+fragment+")");
        ...
        if (chat_id > 0) {
            ...
            Log.e(">>>>> 145", "botHash: " + botHash);
            Log.e(">>>>> 145", "botHash: " + botHash);
            Log.e(">>>>> 145", "botHash: " + botHash);
            Log.e(">>>>> 145", "botHash: " + botHash);


            Log.e(">>>>> 147", "isChannel: " + isChannel);
            Log.e(">>>>> 147", "isChannel: " + isChannel);
            Log.e(">>>>> 147", "isChannel: " + isChannel);
            Log.e(">>>>> 147", "isChannel: " + isChannel);
            ...
            Log.e(">>>>> 149", "isMegagroup: " + isMegagroup);
            Log.e(">>>>> 149", "isMegagroup: " + isMegagroup);
            Log.e(">>>>> 149", "isMegagroup: " + isMegagroup);
            Log.e(">>>>> 149", "isMegagroup: " + isMegagroup);
            ...
            if (botHash == null || isChannel && !isMegagroup) {
                ...
                if (isChannel) {
                    ...
                    if (inputUser instanceof TLRPC.TL_inputUserSelf) {
                        ...
                        Log.e(">>>>> 1000", "if (inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1000", "if (inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1000", "if (inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1000", "if (inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1000", "if (inputUser instanceof TLRPC.TL_inputUserSelf)");
                        ...
                        if (joiningToChannels.contains(chat_id)) {
                            Log.e(">>>>> 1001", "if (joiningToChannels.contains(chat_id))");
                            Log.e(">>>>> 1001", "if (joiningToChannels.contains(chat_id))");
                            Log.e(">>>>> 1001", "if (joiningToChannels.contains(chat_id))");
                            Log.e(">>>>> 1001", "if (joiningToChannels.contains(chat_id))");
                        ...
                        if (user.bot && !isMegagroup) {
                            Log.e(">>>>> 1002", "if (user.bot && !isMegagroup)");
                            Log.e(">>>>> 1002", "if (user.bot && !isMegagroup)");
                            Log.e(">>>>> 1002", "if (user.bot && !isMegagroup)");
                            Log.e(">>>>> 1002", "if (user.bot && !isMegagroup)");
            ...
            ConnectionsManager.getInstance().sendRequest(request, new RequestDelegate() {
                ...
                public void run(TLObject response, final TLRPC.TL_error error) {
                    if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf) {
                        ...
                        Log.e(">>>>> 1009","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1009","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1009","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1009","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1009","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                    ...
                    if (error != null) {
                            ...
                            public void run() {
                                if (fragment != null) {
                                    ...
                                    if (error.text.equals("PEER_FLOOD")) {
                                        ...
                                        Log.e(">>>>> 1010:2","error.text.equals(\"PEER_FLOOD\")");
                                        Log.e(">>>>> 1010:2","error.text.equals(\"PEER_FLOOD\")");
                                        Log.e(">>>>> 1010:2","error.text.equals(\"PEER_FLOOD\")");
                                        Log.e(">>>>> 1010:2","error.text.equals(\"PEER_FLOOD\")");
                                        Log.e(">>>>> 1010:2","error.text.equals(\"PEER_FLOOD\")");
                        ...
                        Log.e(">>>>> 1010:1"," AlertsCreator.showAddUserAlert(error.text: "+error.text+", fragment: "+fragment+", isChannel: "+ isChannel +" && !isMegagroup: "+ isMegagroup +");");
                        Log.e(">>>>> 1010:1"," AlertsCreator.showAddUserAlert(error.text: "+error.text+", fragment: "+fragment+", isChannel: "+ isChannel +" && !isMegagroup: "+ isMegagroup +");");
                        Log.e(">>>>> 1010:1"," AlertsCreator.showAddUserAlert(error.text: "+error.text+", fragment: "+fragment+", isChannel: "+ isChannel +" && !isMegagroup: "+ isMegagroup +");");
                        Log.e(">>>>> 1010:1"," AlertsCreator.showAddUserAlert(error.text: "+error.text+", fragment: "+fragment+", isChannel: "+ isChannel +" && !isMegagroup: "+ isMegagroup +");");
                    ...
                    boolean hasJoinMessage = false;
                    TLRPC.Updates updates = (TLRPC.Updates) response;
                    Log.e(">>>>> 1011"," response" + response.toString());
                    Log.e(">>>>> 1011"," response" + response.toString());
                    Log.e(">>>>> 1011"," response" + response.toString());
                    Log.e(">>>>> 1011"," response" + response.toString());
                    Log.e(">>>>> 1011"," response" + response.toString());
                    Log.e(">>>>> 1011"," response" + response.toString());
                    for (int a = 0; a < updates.updates.size(); a++) {
                        Log.e(">>>>> 1011-1"," response" + updates.updates.get(a).toString());
                        Log.e(">>>>> 1011-1"," response" + updates.updates.get(a).toString());
                        Log.e(">>>>> 1011-1"," response" + updates.updates.get(a).toString());
                        Log.e(">>>>> 1011-1"," response" + updates.updates.get(a).toString());
                        Log.e(">>>>> 1011-1"," response" + updates.updates.get(a).toString());
                    ...
                    if (isChannel) {
                        if (!hasJoinMessage && inputUser instanceof TLRPC.TL_inputUserSelf) {
                            ...
                            Log.e(">>>>> 1012","if (!hasJoinMessage && inputUser instanceof TLRPC.TL_inputUserSelf)");
                            Log.e(">>>>> 1012","if (!hasJoinMessage && inputUser instanceof TLRPC.TL_inputUserSelf)");
                            Log.e(">>>>> 1012","if (!hasJoinMessage && inputUser instanceof TLRPC.TL_inputUserSelf)");
                    ...
                    if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf) {
                        Log.e(">>>>> 1015","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1015","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1015","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1015","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
                        Log.e(">>>>> 1015","if (isChannel && inputUser instanceof TLRPC.TL_inputUserSelf)");
            ...
            if (info instanceof TLRPC.TL_chatFull) {
                ...
                Log.e(">>>>> 1019","if (info instanceof TLRPC.TL_chatFull) ");
                Log.e(">>>>> 1019","if (info instanceof TLRPC.TL_chatFull) ");
                Log.e(">>>>> 1019","if (info instanceof TLRPC.TL_chatFull) ");
                Log.e(">>>>> 1019","if (info instanceof TLRPC.TL_chatFull) ");
